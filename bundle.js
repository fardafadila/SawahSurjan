  ...
  (L.Control.EasyPrint = L.Control.extend({
    ...
    printMap: function (t, e) {
      e && (this.options.filename = e),
        ...
        "auto" === this.originalState.mapWidth
          ...
          : this.originalState.mapWidth.includes("%") && ((this.originalState.percentageWidth = this.originalState.mapWidth), (this.originalState.widthWasPercentage = !0), (this.originalState.mapWidth = this._map.getSize().x + "px")),
    ...
    _togglePageSizeButtons: function (t) {
      var e = this.holder.style,
        n = this.link.style;
      "mouseover" === t.type ? ((e.display = "block"), (n.borderTopLefttRadius = "0"), (n.borderBottomLeftRadius = "0")) : ((e.display = "none"), (n.borderTopLeftRadius = "2px"), (n.borderBottomRightRadius = "2px"));
    },
